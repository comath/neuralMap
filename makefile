...
linearAlgebra_test.o: $(SOURCE)$(UTILS)linearAlgebra.c
	$(CC) $(CCFLAGS) -c $< -o $(BIN)$@
...
linearAlgebra_test: linearAlgebra.o
	$(CC) $(CCFLAGS) $(BIN)$< $(BIN)parallelTree.o -o $@ $(LIB_FLAGS) $(MKLFLAGS) $(PTHREADFLAGS)
